    ...
    <div className="grid gap-4 md:grid-cols-3 px-4 lg:px-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">+10% ce mois</p>
        </CardContent>
      </Card>

      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">XP Totale</CardTitle>
          <Zap className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">1,240 XP</div>
          <p className="text-xs text-muted-foreground">Rang E - Novice</p>
        </CardContent>
      </Card>
    </div>
  )
