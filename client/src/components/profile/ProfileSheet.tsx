      ...
      >
        ...
        <div className="relative h-48 sm:h-64 w-full bg-slate-900 overflow-visible">
          <div 
            ...
            style={{ 
              backgroundImage: `url('https://i.pinimg.com/1200x/cb/41/e9/cb41e9a62a67d07d9000a08d3ad58d3c.jpg')`,
  ...
  return (
    <Card className="relative overflow-hidden border border-border bg-gradient-to-t from-primary/5 to-card shadow-sm transition-all hover:shadow-md">
      <CardHeader className="pb-2">
        ...
        <CardTitle className="text-3xl font-black italic tracking-tighter text-foreground tabular-nums">{value}</CardTitle>
        <div className="absolute right-4 top-4">
          <Badge variant="outline" className="gap-1 bg-background/50 backdrop-blur-sm text-[10px] font-bold px-2 py-0 border-border">
            <TrendingUp className="size-3 text-emerald-500" /> {trend}
          </Badge>
        </div>
      </CardHeader>
      <CardFooter className="flex-col items-start gap-1 pt-0 text-[10px]">
        <div className="flex items-center gap-1.5 font-bold uppercase tracking-tight text-foreground">{footerBold}</div>
